...
You can set the compatibility level for a Stream Analytics job in the Azure portal or by using the [create job REST API call](https://learn.microsoft.com/rest/api/streamanalytics/2020-03-01/streaming-jobs/create-or-replace#compatibilitylevel).

To update the compatibility level of the job in the Azure portal:

1. Use the [Azure portal](https://portal.azure.cn) to locate to your Stream Analytics job.
...
**Previous levels:** [DateTimeOffset](https://learn.microsoft.com/sql/t-sql/data-types/datetimeoffset-transact-sql) types were adjusted to UTC.
