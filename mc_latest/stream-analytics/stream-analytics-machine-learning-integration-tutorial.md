...
Go to the [Azure portal](https://portal.azure.cn) and create a Stream Analytics job. If you're not familiar with this process, see [Create a Stream Analytics job by using the Azure portal](stream-analytics-quick-create-portal.md).
