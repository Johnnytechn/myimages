...
You can [create a Stream Analytics cluster](create-cluster.md) through the [Azure portal](https://portal.azure.cn). If you have any questions or need help with onboarding, you can contact the [Stream Analytics team](mailto:askasa@microsoft.com).
...
Stream Analytics jobs alone don't support VNets. If your inputs or outputs are secured behind a firewall or an Azure Virtual Network, you have the following option:

<!--Not available in MC: stream-analytics-tools-for-visual-studio-install.md stream-analytics-live-data-local-testing.md-->
...
Your Stream Analytics clusters are charged based on the chosen SU capacity. Clusters are billed hourly and there are no additional charges per job running in these clusters. See the [Private Link Service pricing page](https://www.azure.cn/pricing/details/private-link/) for private endpoint billing updates.
