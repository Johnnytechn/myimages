...
<!--Not available in MC: VSCode ASA extension-->
...
You may consider to optimize it to parallel job (as example below) by rewriting your query or updating input/output configurations with the query editor in Azure portal. To learn more, see [Optimize query using job diagram simulator (preview)](./optimize-query-using-job-diagram-simulator.md).
