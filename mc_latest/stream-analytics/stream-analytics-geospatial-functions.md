...
To learn more, visit the [CreateLineString](https://learn.microsoft.com/stream-analytics-query/createlinestring) reference.
...
To learn more, visit the [CreatePoint](https://learn.microsoft.com/stream-analytics-query/createpoint) reference.
...
To learn more, visit the [CreatePolygon](https://learn.microsoft.com/stream-analytics-query/createpolygon) reference.
...
To learn more, visit the [ST_DISTANCE](https://learn.microsoft.com/stream-analytics-query/st-distance) reference.
...
To learn more, visit the [ST_OVERLAPS](https://learn.microsoft.com/stream-analytics-query/st-overlaps) reference.
...
To learn more, visit the [ST_INTERSECTS](https://learn.microsoft.com/stream-analytics-query/st-intersects) reference.
...
To learn more, visit the [ST_WITHIN](https://learn.microsoft.com/stream-analytics-query/st-within) reference.
