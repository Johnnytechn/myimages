...
You can use the [Azure portal](stream-analytics-quick-create-portal.md#configure-job-input),  [Azure PowerShell](https://learn.microsoft.com/powershell/module/az.streamanalytics/New-azStreamAnalyticsInput), [.NET API](https://learn.microsoft.com/dotnet/api/microsoft.azure.management.streamanalytics.inputsoperationsextensions), and [REST API](https://learn.microsoft.com/rest/api/streamanalytics/2020-03-01/inputs) to create, edit, and test Stream Analytics job inputs.
