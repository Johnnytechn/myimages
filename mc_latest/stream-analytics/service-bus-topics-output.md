...
Service Bus queues provide a one-to-one communication method from sender to receiver. [Service Bus topics](https://learn.microsoft.com/previous-versions/azure/hh367516(v=azure.100)) provide a one-to-many form of communication.
...
You can attach query columns as [system properties](https://learn.microsoft.com/dotnet/api/microsoft.servicebus.messaging.brokeredmessage#properties) to your outgoing service bus Queue or Topic messages. 
These columns don't go into the payload instead the corresponding BrokeredMessage [system property](https://learn.microsoft.com/dotnet/api/microsoft.servicebus.messaging.brokeredmessage#properties) is populated with the query column values.
