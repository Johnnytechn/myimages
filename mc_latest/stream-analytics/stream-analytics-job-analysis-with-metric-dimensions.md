...
To understand an Azure Stream Analytics job's health, it's important to know how to use the job's metrics and dimensions. You can use the Azure portal, or an SDK to get the metrics and dimensions that you're interested in. 
<!--Not available in MC: Visual Studio Code Stream Analytics extension-->
